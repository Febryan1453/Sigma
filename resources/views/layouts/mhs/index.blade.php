...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Selamat {{ $salam }}, {{Auth::user()->name}}</h1>
        <ol class="breadcrumb">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tugasDitolak }}</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tugasPeriksa }}</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
