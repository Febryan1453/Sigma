        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Lengkapi data anda</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('mhs.updatemyprofile') }}">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" readonly value="{{ $detailUserMhs->id }}">
                        <div class="form-group">
                            <label for="nim">Nim Mahasiswa</label>
                            <input type="text" readonly value="{{ $detailUserMhs->nim }}" name="nim" class="form-control @error('nim') is-invalid @enderror" id="nim" placeholder="Masukkan nim mahasiswa">
                            @error('nim')
                        ...
                        <div class="form-group">
                            ...
                            <select disabled name="jurusan" class="form-control @error('jurusan') is-invalid @enderror" id="jurusan">
